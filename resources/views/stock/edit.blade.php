...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$stock->item_name}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {!! Form::select('item_type_id', $item_type_id, $stock->item_type_id, ['class' => 'select2 form-control'.($errors->has('item_type_id') ? 'is-invalid':''), 'required'
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('item_name', $stock->item_name,['placeholder' => 'Nama Item','class' => 'form-control '.($errors->has('item_name') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('amount', $stock->amount,['placeholder' => 'Jumlah Stok Barang','class' => 'form-control '.($errors->has('amount') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {!! Form::select('unit_name', $unit_name, $stock->unit_name, ['class' => 'select2 form-control'.($errors->has('unit_name') ? 'is-invalid':''), 'required'
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('unit_price', $stock->unit_price,['placeholder' => '','class' => 'form-control '.($errors->has('unit_price') ? 'is-invalid':''),'required', 'autocomplete' => 'off', 'data-inputmask' => "'alias': 'currency','prefix': ''"])}}
