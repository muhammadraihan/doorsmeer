...
@section('title', 'Stock Request Edit')
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$stock_request->item_id}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['stock_request.update',$stock_request->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('item_id', 'Nama Item',['class' => 'required form-label'])}}
                        {!! Form::select('item_id', $item, $stock_request->item_id, ['class' => 'select2 form-control'.($errors->has('item_id') ? 'is-invalid':''), 'required'
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('amount', $stock_request->amount,['placeholder' => 'Jumlah Stok Barang','class' => 'form-control '.($errors->has('amount') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
