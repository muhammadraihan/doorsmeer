...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$package->name}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['package.update',$package->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('name','Nama Package',['class' => 'required form-label'])}}
                        {{ Form::text('name',$package->name,['placeholder' => 'Nama Package','class' => 'form-control '.($errors->has('name') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('description',$package->description,['placeholder' => 'Deskripsi','class' => 'form-control '.($errors->has('description') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('price',$package->price,['placeholder' => '','class' => 'form-control '.($errors->has('price') ? 'is-invalid':''),'required', 'autocomplete' => 'off', 'data-inputmask' => "'alias': 'currency','prefix': ''"])}}
                        @if ($errors->has('price'))
